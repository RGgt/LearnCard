...
export function CardReverse(props: CardReverseProps) {
  ...
  return (
    <>
      <div
        key={cardId}
        className="absolute m-auto flex h-full w-full flex-col  rounded-2xl bg-gradient-to-t from-blue-700 to-blue-500 p-0  text-slate-100 shadow-lg backface-hidden rotate-x-180"
      >
        <div
          key={cardId}
        ...
        >
          ...
          <br />
          <div
            className="btn-error btn-circle btn invisible m-1.5 h-16 w-16"
            role="button"
            onClick={onRed}
